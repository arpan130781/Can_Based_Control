 ...
 * M155 - [CUSTOM] Set LED parameters: L<index 0-7> D<direction 0|1> S<speed 0-255>. (Requires CUSTOM_M155_COMMAND)
...
public:
  ...
  // ================= CUSTOM M155 LED COMMAND =================
  #if ENABLED(CUSTOM_M155_COMMAND)
    static void M155();
  #endif
  // ===========================================================

  // ================= CAN AXIS SUPPORT (M756) =================
  // M756 is not a standalone GCode command — the CAN axis bridge
  // exposes can_axis_move() and can_axis_home() free functions
  // called directly from G0_G1.cpp and G28.cpp.
  // No GcodeSuite method needed here.
  // ===========================================================
