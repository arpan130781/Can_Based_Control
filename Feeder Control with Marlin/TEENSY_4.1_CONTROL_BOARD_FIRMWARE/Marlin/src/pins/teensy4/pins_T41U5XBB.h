...
#define FAN0_PIN                            11  // Fan0
#define FAN1_PIN                            12  // Fan1
#define FAN2_PIN                            24  // Fan2
#define FAN3_PIN                            25  // Fan3
#define FAN4_PIN                            33  // Fan4
#define FAN5_PIN                            36  // Fan5
#define FAN6_PIN                            13  // Fan5
#define FAN7_PIN                            15  // Fan5


//
// Temperature Sensors
//
#define TEMP_0_PIN                             1  // Extruder / Analog pin numbering: 2 => A2
#define TEMP_1_PIN                             1
